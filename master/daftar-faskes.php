            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-55">
                        <h3>Daftar Faskes</h3>
                        <p>Daftar fasilitas kesehatan tingkat pertama yang berada di kabupaten Boyolali. </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <table align="center" class="tb tb-stripped" style="border: solid black 1px;" border="1">
                    <tr>
