...
<?php 
  ...
  $query_mysql = mysqli_query($connect,"SELECT * FROM persyaratan")or die(mysql_error());
  $nomor = 1;
  ?>
</head>
                                    ...
                                    <div class="row align-items-center">
                                            <div class="col-xl-6 col-md-6">
                                                <div class="business_info">
                                                   <h3>Persyaratan</h3>
                                                    ...
                                                    ?>
                                                    <li> <i class="flaticon-right"></i> <?php echo $data['persyaratan'] ?>.</li>
                                                   <?php }?>
                                                   </p></ul>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6" align="right">
                                                <div class="business_thumb">
                                                        <img style="width: 100%;" src="img/about/kartu1.jpg" alt="">
