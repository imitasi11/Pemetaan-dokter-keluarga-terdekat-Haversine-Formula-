...
if($_POST['upload']){
	...
	$file_tmp = $_FILES['file']['tmp_name'];	
		if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
		    if($ukuran < 2044070){		
			$query=mysqli_query($connect,"UPDATE tb_tempat set nama_tempat='$nama',gambar='$ex',lat='$lat',lng='$lng',lokasi='$alamat',telp='$telp',kecamatan='$kecamatan' where id_tempat='$id'");
			...
			$query=mysqli_query($connect,"UPDATE jadwal set nama_tempat='$nama',Senin='$senins',Selasa='$selasas',Rabu='$rabus',Kamis='$kamiss',Jumat='$jumats',Sabtu='$sabtus',Minggu='$minggus' where nama_tempat='$nama'");
		...
		$query=mysqli_query($connect,"UPDATE tb_tempat set nama_tempat='$nama',gambar='$gambar',lat='$lat',lng='$lng',lokasi='$alamat',telp='$telp',kecamatan='$kecamatan' where id_tempat='$id'");
