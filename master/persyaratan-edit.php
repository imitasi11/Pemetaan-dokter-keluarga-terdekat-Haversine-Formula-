...
<head>
    ...
    $t = $_POST['persyaratan'];
    $query=mysqli_query($connect,"UPDATE persyaratan set persyaratan ='$t' where id_persyaratan='$id'");
...
echo $id;
  ...
  $query_mysql = mysqli_query($connect,"SELECT * FROM persyaratan WHERE id_persyaratan='$id'")or die(mysql_error());
    ?>
</head>
...
<body>
    ...
    <div class="our_department_area">
        <h3 align="center">Edit Persyaratan</h3>
        <div class="container" style="height: 300px;overflow-y: auto;">
           <?php while($data = mysqli_fetch_array($query_mysql)){ ?>
    <!-- form itself end-->
    <form align="center" id="tata-edit" method="post" class="">
        <div class="container">
            <div class="form-group">
                <formalign="center" method="post">
                    <div class="row" align="center">
                        <div class="form-group" style="margin-left: 350px; margin-top: 31px;">
                            <input type="text" value="<?php echo $data['persyaratan'] ?>" name="persyaratan" placeholder="Persyaratan" style="width: 400px;">
                        </div>
                       <div class="col-xl-12">
                            <button type="submit" name="simpan" id="simpan" class="boxed-btn3">Upload</button>
                        </div>
                    </div>
                </form>
            </div>
